...
import FollowerProfileButton from './FollowProfileButton'
...
class Profile extends Component {
    ...
    componentDidMount() {
        const userId = this.props.match.parems.userId;
        this.init(userId);
    }
    ...
    renderProfile = ()=> {
        ...
        let followerBadge = <p style={{ marginBottom: "0" }}><span className='badge badge-pill badge-primary'>{user.follower.length}</span> Follower</p>
                            ...
                            <div className="action-buttons">
                                {isAuthenticated().user && isAuthenticated().user._id === user._id ? (
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 col-xs-6">
                                            <FollowerProfileButton following={following} onButtonClick={this.clickFollowButton} />
                                        </div>
                                    </div>                                            
                                )}
                    ...
                    <div className="col-md-8">
                        <div className="profile-info-right">
                            <Tabs onSelect={(index, label) => console.log(label + ' selected')}>
                                ...
                                <Tab label={followerBadge}  className="tab-title-name">
